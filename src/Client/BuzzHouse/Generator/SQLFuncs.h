...
const std::vector<CHFunction> CHFuncs = {
    ...
    CHFunction(SQLFunc::FUNCJSONExtractKeysAndValues, 0, 0, 1, ulimited_params),
    ...
    CHFunction(SQLFunc::FUNCJSONExtractArrayRawCaseInsensitive, 0, 0, 1, ulimited_params),
    CHFunction(SQLFunc::FUNCJSONExtractBoolCaseInsensitive, 0, 0, 1, ulimited_params),
    CHFunction(SQLFunc::FUNCJSONExtractCaseInsensitive, 0, 0, 1, ulimited_params),
    CHFunction(SQLFunc::FUNCJSONExtractFloatCaseInsensitive, 0, 0, 1, ulimited_params),
    CHFunction(SQLFunc::FUNCJSONExtractIntCaseInsensitive, 0, 0, 1, ulimited_params),
    CHFunction(SQLFunc::FUNCJSONExtractKeysAndValuesCaseInsensitive, 0, 0, 1, ulimited_params),
    CHFunction(SQLFunc::FUNCJSONExtractKeysAndValuesRawCaseInsensitive, 0, 0, 1, ulimited_params),
    CHFunction(SQLFunc::FUNCJSONExtractKeysCaseInsensitive, 0, 0, 1, ulimited_params),
    CHFunction(SQLFunc::FUNCJSONExtractRawCaseInsensitive, 0, 0, 1, ulimited_params),
    CHFunction(SQLFunc::FUNCJSONExtractStringCaseInsensitive, 0, 0, 1, ulimited_params),
    CHFunction(SQLFunc::FUNCJSONExtractUIntCaseInsensitive, 0, 0, 1, ulimited_params),
    ...
    CHFunction(SQLFunc::FUNCendsWithCaseInsensitive, 0, 0, 2, 2),
    ...
    CHFunction(SQLFunc::FUNCauthenticatedUser, 0, 0, 0, 0),
    ...
    CHFunction(SQLFunc::FUNCgenerateSerialID, 0, 0, 1, 2),
