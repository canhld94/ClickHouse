...
-- wrong module name
CREATE FUNCTION is_prime LANGUAGE WASM ABI PLAIN FROM 'unknown_module' ARGUMENTS (num UInt32) RETURNS UInt32; -- { serverError RESOURCE_NOT_FOUND }
-- wrong function name
CREATE FUNCTION unknown_function LANGUAGE WASM ABI PLAIN FROM 'module1' ARGUMENTS (num UInt32) RETURNS UInt32; -- { serverError BAD_ARGUMENTS }
-- wrong argument type
CREATE FUNCTION is_prime LANGUAGE WASM ABI PLAIN FROM 'module1' ARGUMENTS (num UInt64) RETURNS UInt64; -- { serverError BAD_ARGUMENTS }

CREATE FUNCTION is_prime LANGUAGE WASM ABI PLAIN FROM 'module1' ARGUMENTS (num UInt32) RETURNS UInt32;
...
CREATE FUNCTION is_prime LANGUAGE WASM ABI PLAIN FROM 'module1' ARGUMENTS (num UInt32) RETURNS UInt32; -- { serverError FUNCTION_ALREADY_EXISTS }
...
CREATE OR REPLACE FUNCTION is_prime LANGUAGE WASM ABI PLAIN FROM 'module1' ARGUMENTS (UInt32) RETURNS UInt32;
...
CREATE OR REPLACE FUNCTION is_prime LANGUAGE WASM ARGUMENTS UInt32 RETURNS UInt32 FROM 'module1' ABI PLAIN; -- { clientError SYNTAX_ERROR }
-- multivalue RETURNS
CREATE OR REPLACE FUNCTION is_prime LANGUAGE WASM ABI PLAIN FROM 'module1' ARGUMENTS (UInt32) RETURNS (UInt32, UInt32); -- { clientError SYNTAX_ERROR }
-- LANGUAGE is missing
CREATE OR REPLACE FUNCTION is_prime WASM ARGUMENTS (num UInt32) RETURNS UInt32 FROM 'module1' ABI PLAIN; -- { clientError SYNTAX_ERROR }
-- LANGUAGE is wrong
CREATE OR REPLACE FUNCTION is_prime LANGUAGE JS ABI PLAIN FROM 'module1' ARGUMENTS (UInt32) RETURNS UInt32; -- { clientError SYNTAX_ERROR }
-- muplitple ABI keywords
CREATE OR REPLACE FUNCTION is_prime LANGUAGE WASM ABI PLAIN FROM 'module1' ARGUMENTS (UInt32) RETURNS UInt32 ABI PLAIN; -- { clientError SYNTAX_ERROR }
...
CREATE OR REPLACE FUNCTION is_prime LANGUAGE WASM ARGUMENTS (num UInt32) RETURNS (x UInt32) FROM 'module1' ABI PLAIN; -- { clientError SYNTAX_ERROR }
-- illegal literal for module name
CREATE OR REPLACE FUNCTION is_prime LANGUAGE WASM ARGUMENTS (num UInt32) RETURNS UInt32 FROM 123 ABI PLAIN; -- { clientError SYNTAX_ERROR }

CREATE OR REPLACE FUNCTION is_prime LANGUAGE WASM ARGUMENTS (num UInt32) RETURNS UInt32 FROM 'module1' ABI PLAIN;
...
CREATE FUNCTION multi_decl LANGUAGE WASM ABI PLAIN FROM 'wasm_l' ARGUMENTS (a UInt32, b UInt32) RETURNS UInt32; -- { serverError WASM_ERROR }
...
CREATE FUNCTION times2 LANGUAGE WASM ABI PLAIN FROM 'wasm_h' ARGUMENTS (Int32) RETURNS Int32 SHA256_HASH '49174a04c6321c4740b0f4fea5b1a387b38cb56b94bbea533868675e53a'; -- { serverError BAD_ARGUMENTS }
CREATE FUNCTION times2 LANGUAGE WASM ABI PLAIN FROM 'wasm_h' ARGUMENTS (Int32) RETURNS Int32 SHA256_HASH '049174a04c6321c4740b0f4fea5b1a387b38cb56b94bbea533868675e53a'; -- { serverError BAD_ARGUMENTS }
CREATE FUNCTION times2 LANGUAGE WASM ABI PLAIN FROM 'wasm_h' ARGUMENTS (Int32) RETURNS Int32 SHA256_HASH '00049174a04c6321c4740b0f4fea5b1a387b38cb56b94bbea533868675e53a'; -- { serverError BAD_ARGUMENTS }
CREATE FUNCTION times2 LANGUAGE WASM ABI PLAIN FROM 'wasm_h' ARGUMENTS (Int32) RETURNS Int32 SHA256_HASH '1000049174a04c6321c4740b0f4fea5b1a387b38cb56b94bbea533868675e53a'; -- { serverError BAD_ARGUMENTS }
CREATE FUNCTION times2 LANGUAGE WASM ABI PLAIN FROM 'wasm_h' ARGUMENTS (Int32) RETURNS Int32 SHA256_HASH '0000049174a04c6321c4740b0f4fea5b1a387b38cb56b94bbea533868675e53a';
...
CREATE OR REPLACE FUNCTION times2 LANGUAGE WASM ABI PLAIN FROM 'wasm_h2' ARGUMENTS (Int32) RETURNS Int32 SHA256_HASH '79b1fd5fb2e3acb6ca11b436ab354a622d726085effded25cd0ac3046e3'; -- { serverError BAD_ARGUMENTS }
CREATE OR REPLACE FUNCTION times2 LANGUAGE WASM ABI PLAIN FROM 'wasm_h2' ARGUMENTS (Int32) RETURNS Int32 SHA256_HASH '79b1fd5fb2e3acb6ca11b436ab354a622d726085effded25cd0ac3046e30'; -- { serverError BAD_ARGUMENTS }
CREATE OR REPLACE FUNCTION times2 LANGUAGE WASM ABI PLAIN FROM 'wasm_h2' ARGUMENTS (Int32) RETURNS Int32 SHA256_HASH '79b1fd5fb2e3acb6ca11b436ab354a622d726085effded25cd0ac3046e3000'; -- { serverError BAD_ARGUMENTS }
CREATE OR REPLACE FUNCTION times2 LANGUAGE WASM ABI PLAIN FROM 'wasm_h2' ARGUMENTS (Int32) RETURNS Int32 SHA256_HASH '79b1fd5fb2e3acb6ca11b436ab354a622d726085effded25cd0ac3046e300001'; -- { serverError BAD_ARGUMENTS }
CREATE OR REPLACE FUNCTION times2 LANGUAGE WASM ABI PLAIN FROM 'wasm_h2' ARGUMENTS (Int32) RETURNS Int32 SHA256_HASH '79b1fd5fb2e3acb6ca11b436ab354a622d726085effded25cd0ac3046e300000';
